...
void ApplyShadowFighterTraitEffects(ChampState& Champion){
    if (Shadow_Fighters.numchamps >= Shadow_Fighters.treshold[1]){
    ...
    else if(Shadow_Fighters.numchamps >= Shadow_Fighters.treshold[0])
    {
