...
Current Status: Development of custom architecture: Creating trait system activation and team selection(console only for now, raylib will be the last step of the process), champion pool definitions complete(17/17 Champion, balance will be done as part of the polish), trait enumeration complete, stats system complete.
